...
def edit_menu_breed_version_info():
    ...
    choice_edit_information_os_version_which = questionary.prompt(edit_information_os_version_which)
    breed_index_name = choice_edit_information_os_version_which["edit_information_os_version_which"]
    if breed_index_name == "Go Back":
        return
    elif breed_index_name == "":
        print("Unknown option selected. Returning to main menu.")
        return
    update_choices(edit_information_os_version_which_2, get_os_version_names(breed_index_name))
    choice_edit_information_os_version_which_2 = questionary.prompt(edit_information_os_version_which_2)
    my_os_version_name = choice_edit_information_os_version_which_2["edit_information_os_version_which_2"]
    ...
    my_osversion = os_signatures.osbreeds[breed_index].osversions.get(my_os_version_name)
